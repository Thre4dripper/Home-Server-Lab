...
| **Per-service docs** | <!-- AUTOGEN:DOCKER_COUNT -->28<!-- /AUTOGEN:DOCKER_COUNT --> self-contained READMEs | <!-- AUTOGEN:K3S_COUNT -->14<!-- /AUTOGEN:K3S_COUNT --> self-contained READMEs |
| **Resource overhead** | Just Docker daemon (~50 MB RAM) | k3s control plane (~500 MB RAM) |
| **Service count** | **<!-- AUTOGEN:DOCKER_COUNT -->28<!-- /AUTOGEN:DOCKER_COUNT -->** | **<!-- AUTOGEN:K3S_COUNT -->14<!-- /AUTOGEN:K3S_COUNT -->** (and growing) |
