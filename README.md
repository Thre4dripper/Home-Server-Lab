...
| **Per-service docs** | <!-- AUTOGEN:DOCKER_COUNT -->28<!-- /AUTOGEN:DOCKER_COUNT --> self-contained READMEs | <!-- AUTOGEN:K3S_COUNT -->16<!-- /AUTOGEN:K3S_COUNT --> self-contained READMEs |
| **Resource overhead** | Just Docker daemon (~50 MB RAM) | k3s control plane (~500 MB RAM) |
| **Service count** | **<!-- AUTOGEN:DOCKER_COUNT -->28<!-- /AUTOGEN:DOCKER_COUNT -->** | **<!-- AUTOGEN:K3S_COUNT -->16<!-- /AUTOGEN:K3S_COUNT -->** (and growing) |
...
graph TB
    ...
    K3s[☸️ <b>k3s cluster</b><br/>16 apps · production<br/>Traefik IngressRoute<br/>cert-manager · SealedSecrets]
...
| ☸️ k3s | **[k3s/README.md →](./k3s/README.md)** | 16 GitOps-managed Kubernetes apps | 8 |
<!-- /AUTOGEN:CATALOG_TABLE -->
...
├── k3s/                          ☸️  k3s + ArgoCD stack — <!-- AUTOGEN:K3S_COUNT -->16<!-- /AUTOGEN:K3S_COUNT --> apps
